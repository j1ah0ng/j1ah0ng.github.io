...
var app = (function () {
    ...
    /* node_modules/svelte-awesome/components/svg/Path.svelte generated by Svelte v3.31.1 */
    ...
    /* node_modules/svelte-awesome/components/svg/Polygon.svelte generated by Svelte v3.31.1 */
    ...
    /* node_modules/svelte-awesome/components/svg/Raw.svelte generated by Svelte v3.31.1 */
    ...
    /* node_modules/svelte-awesome/components/svg/Svg.svelte generated by Svelte v3.31.1 */
    ...
    /* node_modules/svelte-awesome/components/Icon.svelte generated by Svelte v3.31.1 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Hi, I'm Jiahong.";
    			t2 = space();
    			div1 = element("div");
    			div0 = element("div");
    			t3 = text("I'm a current undergraduate student at the University of California, San\n    Diego studying Computer Engineering and Mathematics for Scientific\n    Computation. My academic interests lie at the intersection of (discrete and\n    numerical) math and computer science. ");
    			br0 = element("br");
    			br1 = element("br");
    			...
    			attr_dev(link0, "sizes", "64x64");
    			add_location(link0, file$4, 7, 4, 178);
    			attr_dev(link1, "rel", "shortcut icon");
    			attr_dev(link1, "type", "image/png");
    			attr_dev(link1, "href", "fav16.png");
    			attr_dev(link1, "sizes", "16x16");
    			add_location(link1, file$4, 12, 4, 295);
    			attr_dev(link2, "rel", "shortcut icon");
    			attr_dev(link2, "type", "image/png");
    			attr_dev(link2, "href", "fav96.png");
    			attr_dev(link2, "sizes", "96x96");
    			add_location(link2, file$4, 17, 4, 410);
    			attr_dev(h1, "class", "svelte-16tq457");
    			add_location(h1, file$4, 25, 1, 545);
    			add_location(br0, file$4, 32, 42, 986);
    			add_location(br1, file$4, 32, 46, 990);
    			set_style(div0, "position", "relative");
    			set_style(div0, "vertical-align", "middle");
    			set_style(div0, "width", "600px");
    			set_style(div0, "text-align", "justify");
    			add_location(div0, file$4, 28, 4, 631);
    			set_style(div1, "display", "flex");
    			set_style(div1, "justify-content", "center");
    			add_location(div1, file$4, 27, 4, 576);
    			add_location(br2, file$4, 34, 40, 1049);
    			add_location(br3, file$4, 34, 44, 1053);
    			attr_dev(a0, "href", "https://github.com/j1ah0ng");
    			attr_dev(a0, "aria-label", "github");
    			add_location(a0, file$4, 37, 12, 1085);
    			attr_dev(li0, "class", "svelte-16tq457");
    			add_location(li0, file$4, 37, 8, 1081);
    			attr_dev(a1, "href", "https://linkedin.com/in/jiahonglong");
    			attr_dev(a1, "aria-label", "linkedin");
    			add_location(a1, file$4, 40, 12, 1241);
    			attr_dev(li1, "class", "svelte-16tq457");
    			add_location(li1, file$4, 40, 8, 1237);
    			attr_dev(path, "d", "M21.469 23.907l-3.595 3.473c-0.624 0.625-1.484 0.885-2.432 0.885s-1.807-0.26-2.432-0.885l-5.776-5.812c-0.62-0.625-0.937-1.537-0.937-2.485 0-0.952 0.317-1.812 0.937-2.432l5.76-5.844c0.62-0.619 1.5-0.859 2.448-0.859s1.808 0.26 2.432 0.885l3.595 3.473c0.687 0.688 1.823 0.663 2.536-0.052 0.708-0.713 0.735-1.848 0.047-2.536l-3.473-3.511c-0.901-0.891-2.032-1.505-3.261-1.787l3.287-3.333c0.688-0.687 0.667-1.823-0.047-2.536s-1.849-0.735-2.536-0.052l-13.469 13.469c-1.307 1.312-1.989 3.113-1.989 5.113 0 1.996 0.683 3.86 1.989 5.168l5.797 5.812c1.307 1.307 3.115 1.937 5.115 1.937 1.995 0 3.801-0.683 5.109-1.989l3.479-3.521c0.688-0.683 0.661-1.817-0.052-2.531s-1.849-0.74-2.531-0.052zM27.749 17.349h-13.531c-0.932 0-1.692 0.801-1.692 1.791 0 0.991 0.76 1.797 1.692 1.797h13.531c0.933 0 1.693-0.807 1.693-1.797 0-0.989-0.76-1.791-1.693-1.791z");
    			add_location(path, file$4, 46, 20, 1599);
    			set_style(svg, "fill", "#5e81ac");
    			attr_dev(svg, "viewBox", "2 -2 36 36");
    			attr_dev(svg, "width", "32");
    			attr_dev(svg, "height", "32");
    			add_location(svg, file$4, 44, 16, 1488);
    			attr_dev(a2, "href", "https://leetcode.com/j1ah0ng");
    			attr_dev(a2, "aria-label", "leetcode");
    			add_location(a2, file$4, 43, 12, 1410);
    			attr_dev(li2, "class", "svelte-16tq457");
    			add_location(li2, file$4, 43, 8, 1406);
    			attr_dev(ul, "class", "svelte-16tq457");
    			add_location(ul, file$4, 36, 9, 1068);
    			attr_dev(nav, "class", "svelte-16tq457");
    			add_location(nav, file$4, 36, 4, 1063);
    			attr_dev(main, "class", "svelte-16tq457");
    			add_location(main, file$4, 24, 0, 537);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Icon, faGithub, faLinkedin });
    	return [];
    }
