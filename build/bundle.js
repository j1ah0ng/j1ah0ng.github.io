    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link0, file$4, 7, 4, 177);
    			attr_dev(link1, "rel", "shortcut icon");
    			attr_dev(link1, "type", "image/png");
    			attr_dev(link1, "href", "fav16.png");
    			attr_dev(link1, "sizes", "16x16");
    			add_location(link1, file$4, 12, 4, 294);
    			attr_dev(link2, "rel", "shortcut icon");
    			attr_dev(link2, "type", "image/png");
    			attr_dev(link2, "href", "fav96.png");
    			attr_dev(link2, "sizes", "96x96");
    			add_location(link2, file$4, 17, 4, 409);
    			attr_dev(h1, "class", "svelte-uua82n");
    			add_location(h1, file$4, 25, 1, 544);
    			add_location(br0, file$4, 27, 40, 611);
    			add_location(br1, file$4, 27, 44, 615);
    			add_location(br2, file$4, 32, 12, 785);
    			attr_dev(a0, "href", "https://github.com/j1ah0ng");
    			attr_dev(a0, "aria-label", "github");
    			add_location(a0, file$4, 30, 12, 647);
    			attr_dev(li0, "class", "svelte-uua82n");
    			add_location(li0, file$4, 30, 8, 643);
    			add_location(br3, file$4, 36, 12, 971);
    			attr_dev(a1, "href", "https://linkedin.com/in/jiahonglong");
    			attr_dev(a1, "aria-label", "linkedin");
    			add_location(a1, file$4, 34, 12, 820);
    			attr_dev(li1, "class", "svelte-uua82n");
    			add_location(li1, file$4, 34, 8, 816);
    			attr_dev(ul, "class", "svelte-uua82n");
    			add_location(ul, file$4, 29, 9, 630);
    			attr_dev(nav, "class", "svelte-uua82n");
    			add_location(nav, file$4, 29, 4, 625);
    			attr_dev(main, "class", "svelte-uua82n");
    			add_location(main, file$4, 24, 0, 536);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
